...
class GSEAPlot(object):
    ...
    def axes_stat(self, rect):
        ...
        ax4.text(0.1, 0.1, self._fdr_label, transform=ax4.transAxes)
        ax4.text(0.1, 0.2, self._pval_label, transform=ax4.transAxes)
        ax4.text(0.1, 0.3, self._nes_label, transform=ax4.transAxes)
