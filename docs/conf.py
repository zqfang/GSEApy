...
_meta = _metadata("gseapy")
author = parseaddr(_meta["Author-email"])[0]
project = _meta["Name"]
...
latex_documents = [
    (master_doc, "gseapy.tex", "gseapy Documentation", "Zhuoqing Fang", "manual"),
]
...
man_pages = [(master_doc, "gseapy", "gseapy Documentation", [author], 1)]
